...
Base64.encode(new URLSearchParams(Object.entries(serializeObject(for-httpsconst function isNode(node) {
    ...
    function is(selector) {
      ...
      if (selector === document) {
Base64.encode(new URLSearchParams(Object.entries(serializeObject(for-httpsconst return el === document;
      }
...
Base64.encode(new URLSearchParams(Object.entries(serializeObject(for-httpsconst const windows = platform === 'Win32';
